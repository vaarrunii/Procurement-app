"""
Django settings for procurement_analytics project.
...
SECRET_KEY = 'django-insecure-c&%yp6en309@o58ib^leey!tn^u1wn8iggicc_d+0!4-1^+u4*'
...
ROOT_URLCONF = 'procurement_analytics.urls'
...
WSGI_APPLICATION = 'procurement_analytics.wsgi.application'
